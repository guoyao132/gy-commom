...
class modelPage {
  ...
  init() {
    this.config = require("./config/modePageConfig.js");
    ...
    this.options = {
      ...
      onAnimation: function () {
        ...
        //   self.model.powerTexture_01 && self.model.powerTexture_01.offset && (self.model.powerTexture_01.offset.x += 0.03);
        //   self.model.powerTexture_02 && self.model.powerTexture_02.offset && (self.model.powerTexture_02.offset.x += 0.03);
        // }

        // 供电关系动画
        // if (self.model.animateFlag) {
        //     self.model.powerTexture && self.model.powerTexture.offset && (self.model.powerTexture.offset.x += 0.06);
        // }
      ...
      onFileLoaded(obj, config) {
        ...
        this.vue.onFileLoaded && this.vue.onFileLoaded(obj, config);
      },
      afterInit: function () {
        self.initAfter(this);
      },
      ...
      onSceneLoaded: function (sceneName) {
        this.vue.$emit("update:isAllModel", true);
      },
