...
import {MyTextureLoader} from './MyTextureLoader'
...
MyMTLLoader.prototype = Object.assign(Object.create(Loader.prototype), {
  ...
  parse: function (text, path) {
    ...
    var materialCreator = new MyMTLLoader.MaterialCreator(this.resourcePath || path, this.materialOptions);
...
MyMTLLoader.MaterialCreator = function (baseUrl, options) {
...
MyMTLLoader.MaterialCreator.prototype = {

  constructor: MyMTLLoader.MaterialCreator,
  ...
  create: function (materialName) {
    ...
    if (this.materials[materialName] === undefined) {
      return new Promise(resolve => {
        this.createMaterial_(materialName).then(function () {
            resolve()
          }
        )
      })
  ...
  createMaterial_: async function (materialName) {
    ...
    scope.materials[materialName] = new MeshPhongMaterial(params);
    return scope.materials[materialName];
  ...
  loadTexture: function (url, mapping, onLoad, onProgress, onError) {
    return new Promise(resolve => {
      ...
      if (loader === null) {
        ...
        loader = new MyTextureLoader(manager);
