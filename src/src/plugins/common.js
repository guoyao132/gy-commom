 ...
 */
  ...
  * @param {object} validatorObj 验证规则对象
  */
  ...
  * @gy
  * @2020/9/14 10:48
  * @description 格式化echarts数据，将数据变为一个数组，x为value的数组
  * @param {array} xData 时间轴数组(年月日时分秒)
  * @param {array} yData y周数组
  */
