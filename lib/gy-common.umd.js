...
/* harmony default export */ var common = ({
  //浮点数减法
  floatSub: function floatSub(num1, num2) {
    var r1, r2, m;
  ...
  //浮点数加法
  floatAdd: function floatAdd(num1, num2) {
    var r1, r2, m;
  ...
  //浮点数乘法
  floatMul: function floatMul(num1, num2) {
    var m = 0,
        s1 = num1.toString(),
        s2 = num2.toString();
   ...
   *
   * */
  formatTime: function formatTime(time, type) {
  ...
  //获取上标或者下标数字
  getSmallNum: function getSmallNum(num) {
  ...
  //获取星期几
  convDate: function convDate() {
    var num = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
    return '星期' + '日一二三四五六'.substr(num, 1);
  },
  //获取月份有多少天
  getMonthLen: function getMonthLen() {
...
// EXTERNAL MODULE: ./src/plugins/css/reset.css
var css_reset = __webpack_require__("26d7");
